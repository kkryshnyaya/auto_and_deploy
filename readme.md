...
•	constants.ini содержит: наименования директорий, параметры торговой сети, категории товаров и собственно товары;
•	creds.ini содержит параметры подключения к БД, поэтому попадает в .gitignore. На удаленном сервере создан клон этого файла, так как скрипт на него ссылается;
...
•	Установить Python виртуальное окружение
Проект работает на Python 3.12.10
apt install python3 -y 
apt install python3-venv -y

•	Клонировать проект и перейти в папку проекта
git clone https://github.com/kkryshnyaya/auto_and_deploy.git
cd auto_and_deploy
